...
@Model.register("decomposable_attention_modified")
class DecomposableAttentionModified(Model):
    ...
    def forward(self,  # type: ignore
        ...
        aggegrate_output = self._aggregate_feedforward(aggregate_input)
        label_logits = self._output_layer(aggegrate_output)
