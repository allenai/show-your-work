...
@Model.register("bcn_modified")
class BiattentiveClassificationNetworkModified(Model):
    """
    ...
    def __init__(self,
        ...
        super(BiattentiveClassificationNetworkModified, self).__init__(vocab, regularizer)
        ...
        self._embedding_dropout = nn.Dropout(float(embedding_dropout))
        self._num_classes = self.vocab.get_vocab_size("labels")

        self._pre_encode_feedforward = pre_encode_feedforward
        self._encoder = encoder
        self._integrator = integrator
        self._integrator_dropout = nn.Dropout(float(integrator_dropout))
        ...
        self._logit_layer = torch.nn.Linear(self._output_layer.get_output_dim(), self._num_classes)
    ...
    def forward(self,  # type: ignore
        ...
        output = self._output_layer(pooled_representations_dropped)
        logits = self._logit_layer(output)
